...
export default function ExtraInfoInner() {
    ...
    const filteredSlots = slots.filter((iso) => new Date(iso) > now);
    ...
    const handleBack = () => {
        const qs = new URLSearchParams({ vehicleIdType, vehicleIdValue, serviceType }).toString();
                ...
                <div>
                    ...
                    <div className="flex justify-center">
                        <DayPicker
                            ...
                            styles={{ caption: { textAlign: "center" }, month: { margin: "0 auto" } }}
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-xl border shadow ${
                                                selectedSlot === iso ? "ring-4 ring-blue-400 bg-white" : "bg-white/60 hover:bg-white"
                                            }`}
                                        >
                                            {label}
                                        </button>
